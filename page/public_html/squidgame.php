...
<body>
    ...
    <div class="container"><div class="row"><div class="col">
        ...
        <p><b class="fs-5">1. </b>Az első feladatot <a href="https://www.codeguppy.com/code.html?RxVnjIbOqlCxNvXBK8ex" target="_blank">INNEN</a> tudod megnyitni. Ezeket az utasításokat kapod meg:</p>
...
<pre>function solution()
{
    ...
    println(roomCnt(3))
        ...
        <p><b class="fs-5">2. </b>Az második feladatot <a href="https://www.codeguppy.com/code.html?dlcEpHHe7gJmIFLjkuFN" target="_blank">INNEN</a> tudod megnyitni. Leszóltak a főnökségtől, hogy túl sokat lövöldözöl odakint, akkor is, amikor egy játékos sem maradt odakint, hanem mindenki bement egy szobába. Szerencsére kaptál egy új utasítást:</p>
        ...
        <p><b class="fs-5">3. </b>A harmadik feladatot <a href="https://aijs.io/editor?user=trivia21&project=Tintahalj%C3%A1t%C3%A9k-3" target="_blank">INNEN</a> tudod megnyitni. Bal oldalon a fájlok közül a <code>solution.js</code> fájlt kell megnyitni, abba írni a megoldást.</p>
...
<em>satöbbi...</em></pre>
        ...
        <p>Szuper! Ha kész vagy, meg is van a 3 csillagod. Mi lenne, ha azt mondanám, lehet megvan a koronád is? Nyisd meg <a href="https://aijs.io/editor?user=trivia21&project=Tintahalj%C3%A1t%C3%A9k-4" target="_blank">EZT</a> az új linket, és próbáld átmásolni ide is a kódodat. Ha működik, nincs más teendőd. Ha nem, megpróbálhatod kijavítani, és feltölteni a 3. feladathoz. Itt is ugyanaz a feladat.</p>
        <div class="alert alert-info overflow-x-hidden" role="alert">
